...
export default async function AdminCityAgentsPage() {
  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-2xl font-bold text-[#1A0A53] sm:text-3xl">City agents</h1>
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-[#5b6b82]">
        ...
        local agent&rsquo;s name, address, phone and email, and a link visitors can share straight to
