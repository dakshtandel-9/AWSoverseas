...
export const metadata: Metadata = { title: "Admin | AWSoversea", robots: { index: false, follow: false } };

export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-[#f6f8fc]">
      <aside className="hidden w-64 shrink-0 border-r border-[#e4e9f2] bg-white px-5 py-6 lg:flex lg:flex-col">
        <Logo className="px-1" />
