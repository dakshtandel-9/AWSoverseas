        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-[#e4e9f2] bg-white p-5">
              ...
              <p className="mt-1.5 text-2xl font-bold text-[#06234d]">₹{summary.available.toLocaleString("en-IN")}</p>
            </div>
            <div className="rounded-2xl border border-[#e4e9f2] bg-white p-5">
              <p className="text-xs font-semibold uppercase tracking-wide text-[#94a3b8]">Pending withdrawal</p>
              <p className="mt-1.5 text-2xl font-bold text-[#06234d]">
            ...
            <div className="rounded-2xl border border-[#e4e9f2] bg-white p-5">
              ...
              <p className="mt-1.5 text-2xl font-bold text-[#06234d]">₹{summary.earned.toLocaleString("en-IN")}</p>
            </div>
          </div>
