  ...
  if (done) {
    return (
      <div className="flex flex-col items-center gap-4 py-4 text-center">
        ...
        <p className="text-base font-bold text-[#01214a]">Password updated</p>
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <label className="text-sm font-semibold text-[#01214a]">New password</label>
        <input
          type="password"
          required
          minLength={8}
      ...
      <div className="flex flex-col gap-2">
        <label className="text-sm font-semibold text-[#01214a]">Confirm new password</label>
        <input
          type="password"
          required
          autoComplete="new-password"
