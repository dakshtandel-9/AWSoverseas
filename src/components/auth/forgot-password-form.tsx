  ...
  if (sent) {
    return (
      <div className="flex flex-col items-center gap-4 py-4 text-center">
        <span className="grid size-12 shrink-0 place-items-center rounded-full bg-[#eef3fb] text-[#002144]">
          <Mail className="size-6" />
        </span>
        <div>
          <p className="text-base font-bold text-[#002144]">Check your inbox</p>
