...
/**
 * Continues the manifest register from About/Industries/Services, this time
 * as an export schedule — the stat block reuses overview.stats already on
 * this page's JSON rather than inventing numbers.
 */
export function ProductsHero({ data, stats }: { data: Data; stats: Stat[] }) {
