        ...
        <div className="mt-10 flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            >
              ...
              <Button href="#how-it-works" size="lg" variant="ghost" className="text-[#1A0A53] hover:bg-[#002144]/10">
          ...
          >
            ...
            >
              ...
              <span className="text-center text-xs font-medium uppercase tracking-wide text-[#1A0A53]/55">
                {data.stat.label}
              </span>
            </div>
          </motion.div>
