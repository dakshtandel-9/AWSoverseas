...
/**
 * Referral reward control shown on a quote/enquiry row. Renders one of
 * three states depending on the booking: no referrer on the account,
 * already credited, or the credit form.
 */
