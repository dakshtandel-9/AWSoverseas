  ...
  return (
    <div className="mt-4 flex flex-wrap items-end gap-2.5 border-t border-[#e4e9f2] pt-4">
      ...
      <input
        ...
        className="min-w-[200px] flex-1 rounded-lg border border-[#e4e9f2] px-2.5 py-1.5 text-xs text-[#06234d] placeholder:text-[#94a3b8]"
      />
      <button
        type="button"
        disabled={pending}
    ...
    <div className="rounded-2xl border border-[#e4e9f2] bg-white">
      ...
      >
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-bold text-[#06234d]">{requesterName}</p>
      ...
      {open && (
        <div className="border-t border-[#e4e9f2] px-5 py-4">
          ...
          <div className="grid gap-2 text-sm leading-relaxed text-[#06234d]">
            <p>
