...
import { uploadCategoryImageAction, type ImageUploadState } from "@/app/admin/(dashboard)/categories/actions";

const initialState: ImageUploadState = {};

/**
 * Standalone upload form (not nested inside the category form) so its own
 * useActionState dispatch can never collide with the category-save action on
 * the same page.
 */
