    ...
    <Section spacing="md">
      <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:gap-16">
        <Reveal direction="up">
          ...
          <h2 className="mt-3 text-3xl font-bold text-[#1A0A53] sm:text-4xl lg:text-[2.25rem]">
            {data.title}
          </h2>
        ...
        >
          {data.features.map((f) => (
            <motion.li
              key={f}
              className="flex items-center gap-3 rounded-xl border border-[#e4e9f2] bg-white px-4 py-3.5 text-sm font-semibold text-[#1A0A53]"
              variants={{
