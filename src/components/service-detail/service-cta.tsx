      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-[2rem] bg-[#C4DFFD] px-8 py-16 text-center shadow-[0_32px_96px_-24px_rgba(4,22,47,0.25)] sm:px-14 sm:py-20">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(50% 60% at 50% -10%, rgba(144, 45, 57,0.18) 0%, transparent 60%), linear-gradient(to right, rgba(1,33,74,0.05) 1px, transparent 1px), linear-gradient(to bottom, rgba(1,33,74,0.05) 1px, transparent 1px)",
