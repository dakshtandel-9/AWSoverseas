    ...
    <Section spacing="lg">
      ...
      >
        ...
        <div className="relative mx-auto max-w-lg">
          <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-ink/10 ring-1 ring-ink/15">
            <Mail className="size-6 text-[#e05c72]" />
          </span>
          <h2 className="mt-6 text-3xl font-bold sm:text-4xl" style={{ color: "#01214a" }}>
            {data.title}
          </h2>
