      ...
      {slideCount > 1 && (
        <>
          <button
            ...
            className="absolute left-4 top-1/2 z-10 hidden size-11 -translate-y-1/2 place-items-center rounded-full border border-white/20 bg-white/[0.08] text-white backdrop-blur-md transition-colors duration-200 hover:bg-white/[0.18] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d72846] sm:left-6 md:grid"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 z-10 hidden size-11 -translate-y-1/2 place-items-center rounded-full border border-white/20 bg-white/[0.08] text-white backdrop-blur-md transition-colors duration-200 hover:bg-white/[0.18] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d72846] sm:right-6 md:grid"
          >
          ...
          <div className="absolute inset-x-0 bottom-6 z-10 flex justify-center gap-2.5">
            {slides.map((_, i) => (
              <button
                ...
                className="rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d72846]"
                style={{
                  width: i === index ? 28 : 9,
                  height: 9,
                  background: i === index ? "#d72846" : "rgba(255,255,255,0.35)",
                }}
              />
            ))}
          </div>
