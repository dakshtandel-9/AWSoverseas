  ...
  return (
    <section className="relative overflow-hidden bg-white py-24 sm:py-32">
      ...
      <div className="relative mx-auto mb-16 flex max-w-[1280px] items-center gap-6 px-4 sm:px-6 lg:px-8">
        ...
        <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#5b6b82]">About aws overseas impex</span>
        <div className="h-px flex-1 bg-[#e4e9f2]" />
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_auto_1.1fr] lg:gap-0">
          ...
          >
            ...
            <motion.div variants={copyItem} className="mt-10">
              <Link
                href="/about"
                className="group inline-flex items-center gap-2 rounded-full btn-navy px-8 py-4 text-base font-semibold text-white shadow-[0_2px_8px_rgba(3,62,141,0.25)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_0_4px_rgba(144, 45, 57,0.18),0_8px_24px_rgba(3,62,141,0.35)]"
              >
                {data.button}
