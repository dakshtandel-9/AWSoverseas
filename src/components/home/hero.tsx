      ...
      <div className="relative w-full max-w-md scale-[0.82] sm:scale-90 sm:mr-10 lg:mr-0 lg:scale-100">
        ...
        >
          ...
          <div className="mt-5 flex items-center gap-2.5 rounded-2xl bg-[#f6f8fc] px-4 py-3">
            <MapPin className="size-4 shrink-0 text-[#d6274c]" />
            ...
            <div className="flex flex-1 items-center gap-1">
              {[0, 1, 2, 3, 4].map((i) => (
                <span
                  ...
                  style={{ background: i < 3 ? "#d6274c" : "#e4e9f2" }}
                />
              ))}
            </div>
          ...
          <ol className="mt-5 space-y-3.5">
            {SHIPMENT_STEPS.map((step) => (
              <li key={step.id} className="flex items-start gap-3">
                {step.done ? (
                  <CheckCircle2 className="mt-0.5 size-4.5 shrink-0 text-[#d6274c]" />
                ) : step.active ? (
                  <motion.span
          ...
          <div className="mt-5 flex items-center gap-2 rounded-xl bg-[#002144] px-4 py-3">
            <Clock className="size-4 shrink-0 text-[#d6274c]" />
          ...
          >
            ...
            <a
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow = "0 0 0 1px rgba(171, 31, 61,0.4), 0 4px 20px rgba(171, 31, 61,0.15)";
