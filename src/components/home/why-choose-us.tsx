  ...
  return (
    <Section spacing="lg" className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse 60% 40% at 30% 0%, rgba(10,165,240,0.06) 0%, transparent 65%), linear-gradient(to right, rgba(4,22,47,0.032) 1px, transparent 1px), linear-gradient(to bottom, rgba(4,22,47,0.032) 1px, transparent 1px)",
      ...
      <Reveal direction="up">
        <div className="relative max-w-2xl">
          <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#5b6b82]">Why AWSoversea</p>
      ...
      <div className="relative mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {data.items.map((item, i) => {
          ...
          return (
            ...
            >
              {/* Left accent stripe */}
              <span className="absolute inset-y-0 left-0 w-[3px] origin-top scale-y-0 bg-gradient-to-b from-[#033e8d] to-[#0fade8] transition-transform duration-300 group-hover:scale-y-100 rounded-l-3xl" />
              ...
              <div className="flex items-start justify-between">
                ...
                <motion.span
                  className="size-2.5 rounded-full transition-shadow duration-300 group-hover:shadow-[0_0_8px_3px_rgba(15,173,232,0.45)]"
                  style={{ background: useAmber ? "#f59e0b" : "#0fade8" }}
                />
              </div>
              ...
              {metric && (
                <span
                  ...
                  style={{ color: useAmber ? "#d97706" : "#0fade8" }}
                >
                  <span
                    className="size-1.5 rounded-full"
                    style={{ background: useAmber ? "#d97706" : "#0fade8" }}
                  />
                  {metric}
                </span>
              )}
      ...
      >
        <div className="flex flex-col items-center gap-4 text-center">
          <p className="text-base font-semibold text-[#06234d]">Ready to ship globally?</p>
          <Link
            href="/quote"
            className="group inline-flex items-center gap-2 rounded-full bg-[#033e8d] px-8 py-3.5 text-sm font-semibold text-white shadow-[0_2px_8px_rgba(3,62,141,0.25)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#052f69] hover:shadow-[0_0_0_4px_rgba(15,173,232,0.18),0_8px_24px_rgba(3,62,141,0.35)]"
          >
            Request a Quote
