      ...
      <div className="relative flex items-center">
        ...
        <svg viewBox="0 0 320 12" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
          <motion.line
            ...
            stroke="white" strokeWidth="1.5" strokeDasharray="6 8"
            initial={{ pathLength: 0, opacity: 0 }}
            whileInView={{ pathLength: 1, opacity: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 1.2, ease: "easeInOut", delay: 0.3 }}
          />
          <motion.circle cx="6" cy="6" r="3.5" fill="white"
            initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }}
            transition={{ delay: 0.4, duration: 0.3, ease: "backOut" }}
          />
          <motion.circle cx="314" cy="6" r="3.5" fill="white"
            initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }}
        ...
        >
          <Plane className="size-10 text-white" style={{ transform: "rotate(45deg)" }} strokeWidth={1.5} fill="white" />
        </motion.div>
      </div>
    </div>
  );
