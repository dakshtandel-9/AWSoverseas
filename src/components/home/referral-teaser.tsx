      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-[2rem] bg-[#CFE8FF] px-8 py-14 shadow-[0_32px_96px_-24px_rgba(5,32,58,0.25)] sm:px-14 sm:py-16">
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(55% 60% at 90% 10%, rgba(144, 45, 57,0.12) 0%, transparent 60%), linear-gradient(to right, rgba(1,33,74,0.05) 1px, transparent 1px), linear-gradient(to bottom, rgba(1,33,74,0.05) 1px, transparent 1px)",
