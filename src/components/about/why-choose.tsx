        ...
        >
          {data.items.map((item) => {
            ...
            return (
              ...
              >
                <span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-white text-[#002144] shadow-[0_1px_2px_rgba(4,22,47,0.04),0_8px_20px_-10px_rgba(4,22,47,0.18)] ring-1 ring-[#e4e9f2] transition-all duration-300 group-hover:bg-[#002144] group-hover:text-white">
