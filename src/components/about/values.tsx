      ...
      <div className="mt-12 grid gap-x-12 sm:grid-cols-2">
        {data.items.map((item, i) => {
          ...
          return (
            ...
            >
              <span className="mt-0.5 grid size-11 shrink-0 place-items-center rounded-xl bg-white text-[#002144] shadow-[0_1px_2px_rgba(4,22,47,0.04),0_8px_20px_-10px_rgba(4,22,47,0.2)] ring-1 ring-[#e4e9f2] transition-colors duration-300 group-hover:bg-[#002144] group-hover:text-white">
                <Icon className="size-5" />
              </span>
              <div className="min-w-0">
                <h3 className="text-base font-bold text-[#002144]">{item.title}</h3>
