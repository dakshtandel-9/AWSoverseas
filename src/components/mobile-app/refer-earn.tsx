  ...
  return (
    <Section spacing="lg" tone="ink" className="overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(55% 45% at 90% 0%, rgba(172,32,56,0.18) 0%, transparent 60%), radial-gradient(50% 45% at 5% 100%, rgba(3,62,141,0.4) 0%, transparent 55%)",
        }}
      />

      <div className="relative grid gap-14 lg:grid-cols-[1fr_1fr] lg:gap-16 lg:items-center">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full border border-[#d72846]/30 bg-[#d72846]/8 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#e05c72]">
