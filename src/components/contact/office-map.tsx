  ...
  return (
    <Section spacing="lg" tone="soft">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h2 className="mt-3 text-3xl font-bold text-[#06234d] sm:text-4xl">
      ...
      >
        ...
        >
          <div className="flex flex-col items-center gap-3">
            <span className="grid size-14 place-items-center rounded-full bg-[#033e8d] text-white shadow-[0_8px_24px_-6px_rgba(3,62,141,0.5)]">
        ...
        <div className="flex flex-col items-start gap-4 border-t border-[#e4e9f2] px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          ...
          <a
            ...
            className="group inline-flex shrink-0 items-center gap-1.5 rounded-full bg-[#eef3fb] px-5 py-2.5 text-sm font-semibold text-[#033e8d] transition-colors hover:bg-[#033e8d] hover:text-white"
          >
            Open in Google Maps
